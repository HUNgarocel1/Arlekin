...
class SystemDialog(ui.ScriptWindow):
	...
	#	self.GetChild("change_ch_button").SAFE_SetEvent(self.__switch_channel)
		self.GetChild("switch_button").SAFE_SetEvent(self.__toggleSwitchbot)
...
class MoveChannelWindow(ui.ScriptWindow):
	...
	def ChangeChannel(self):
		...
		if channelState == serverInfo.STATE_NONE or channelState == serverInfo.STATE_DICT[0]:
			chat.AppendChat(chat.CHAT_TYPE_INFO , "[Csatorna váltás] Ez a csatorna offline..")
			return
