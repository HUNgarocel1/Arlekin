...
class InventoryWindow(ui.ScriptWindow):
	...
	def __ClickStartButton(self):
		...
		startQuestionDialog.SetText1("A lelt·radat teljesen rendbe tudom szedni.")
		startQuestionDialog.SetText2("Viszont ezt azt ·tpakolok ha nem gond.")
	...
	def OpenPickMoneyDialog(self):
		...
		if mouseModule.mouseController.isAttached():
			...
			self.dlgPickMoney.SetMax(7) # ¿Œ∫•≈‰∏Æ 990000 ¡¶«— πˆ±◊ ºˆ¡§
