...
window = {
	...
	(
		...
		{ 
			...
			"children" : 
			(
				{ "name":"AP0_TEXT", "type":"text", "x": 16, "y": 40, "text": " ÜZENET ", "r":1.0, "g":20.0, "b":20.0, "a":1.0, "text_horizontal_align":"center" },	
			),
		},
		{ 
			...
			"children" : 
			(
				{ "name":"AP1_TEXT", "type":"text", "x": 16, "y": 40, "text": " CHAT TILTÁS ", "r":1.0, "g":20.0, "b":20.0, "a":1.0, "text_horizontal_align":"center" },	
			),
		},
		{ 
			...
			"children" : 
			(
				{ "name":"AP2_TEXT", "type":"text", "x": 16, "y": 40, "text": " BAN RENDSZER ", "r":1.0, "g":20.0, "b":20.0, "a":1.0, "text_horizontal_align":"center" },	
			),
		},
		{
			"name" : "GiftIcon",
