	...
	(
		{
			...
			(
				...
				{ 
					...
					"children" :
					(
						{"name":"TitleName", "type":"text", "x":0, "y":0, "text":"Házikedvenc", "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"LevelTitle", "type":"text", "x":0, "y":0, "text": "Szint", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## Level Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"ExpTitle", "type":"text", "x":0, "y":0, "text": "Tapasztalat", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## EXP Gauge
				{
				...
				{ 
					...
					"children" :
					(
						{"name":"AgeTitle", "type":"text", "x":0, "y":0, "text": "Kor", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## AGE Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"LifeTitle", "type":"text", "x":0, "y":0, "text": "Idõtartam", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"AbilitiesName", "type":"text", "x":0, "y":0, "text": "Bónuszok", "r":1.0, "g":0.0, "b":0.0, "a":1.0, "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"HpTitle", "type":"text", "x":0, "y":0, "text": "TP", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## HP Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"DefTitle", "type":"text", "x":0, "y":0, "text": "Védekezés", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## Defence Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"SpTitle", "type":"text", "x":0, "y":0, "text": "MP", "color":GOLD_COLOR, "all_align" : "center"},
					),
				},
				## SP Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"PetSkillTitle", "type":"text", "x":0, "y":0, "text": "Készség", "r":1.0, "g":0.0, "b":0.0, "a":1.0, "all_align" : "center"},
					),
				},
