				...
				
		{
			...
			(
				...
				
				{
					...
					"multi_line" : 1,
					"limit_width" : 590,
					"text" : "Kedves Arlekin Online játékosok! Hamarason Szerver frissítés fog következni! Idõpont: -> <-. Köszönjük szépen hogy itt vagytok, további jó játékot kívánunk! Adminisztrátor csapat.",
				},
