...
class CharacterWindow(ui.ScriptWindow):
	...
	def __ClickEmotionSlot(self, slotIndex):
		...
		if self.lastUpdate3 < app.GetGlobalTime():
			self.lastUpdate3=app.GetGlobalTime()+5000 # 5 secunde 	
			if slotIndex > 50:
			...
			import chat
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Asteapta 5 secunde pentru a folosi emotia din nou.")
